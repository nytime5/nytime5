...
Instructions specific to article voice and writer assignment. Read the root `CLAUDE.md` for site-wide conventions and `wiki/CLAUDE.md` for the fictional universe.

For format specs (front matter, byline, image, checklist), see `.claude/references/article-format.md`.
For the full article creation workflow, see `.claude/commands/write-article.md` or invoke `/write-article`.
...
**Wildlife and nature:** Jane Goodsome. Covers all stories involving animals, ecology, interspecies relations, and the natural world. Treats animal communities as legitimate polities with governance structures. Files late.
