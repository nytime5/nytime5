...
**Opinion columnists:** Gerald K. Vanderbeek (libertarian), Judith Ann Crossley (nostalgist), Frank J. DiOrio (law-and-order), Kevin Shao (techno-optimist), Nancy Ostrander (localist), Dr. Elena Voss (environmentalist), Graham T. Weatherstone (centrist), Raúl Alejandro Guzmán (historical-determinist)

---

## Writer Headshot Generation

Every staff writer has a headshot portrait stored as a `.jpg` in `wiki/people/`, colocated with their Markdown profile. These are displayed as 120x120px circles (CSS `border-radius: 50%`).
...
- **Framing for circular crop.** The head must be centered with enough margin on all sides that a circle inscribed in the square won't clip hair, ears, or chin. No shirt/shoulders — just a hint of collar at the bottom edge.
