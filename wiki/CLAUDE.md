...
For entry format specs (front matter, required sections, place guidelines), see `.claude/references/wiki-entry-format.md`.
For cross-linking rules, see `.claude/references/cross-linking.md`.
To create a new entry, invoke `/create-wiki-entry`.
...
The world of *The New York Time5* is a hybrid of reality and fiction. It is our world with the dial turned up. The full elaboration of how this world works — its expertise economy, institutional gravity, data fetish, legislative seriousness, and core mechanic of mundane escalation — is documented in [`wiki/universe.md`](/wiki/universe/).
...
- **Places** are real geography with exaggerated local character. Every city, town, or neighborhood that appears in a story gets a wiki entry.
...
**Opinion columnists:** Gerald K. Vanderbeek (libertarian), Judith Ann Crossley (nostalgist), Frank J. DiOrio (law-and-order), Kevin Shao (techno-optimist), Nancy Ostrander (localist), Dr. Elena Voss (environmentalist), Graham T. Weatherstone (centrist), Raúl Alejandro Guzmán (historical-determinist), Kristoffer Kitchens (contrarian-polemicist), Jorge Will (conservative-intellectual), Marjorie Taylor Blue (populist-conspiratorial), Emily Nutella (concerned-citizen)
...
As the wiki grows, watch for:
- **Connections between entries** — link related characters, organizations, and events into a web.
- **Gaps in coverage** — if articles keep inventing one-off experts in a domain, that domain needs a wiki character.
- **Voice drift** — periodically reread writer Private Profiles to ensure articles stay true to each voice.
- **World coherence** — reconcile any contradictions between entries.
