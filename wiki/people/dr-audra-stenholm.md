---
title: "Dr. Audra Stenholm"
type: person
subtype: expert
status: active
first-appearance: 2026-06-19
---

## Public Biography

**Dr. Audra Stenholm** is an ethnobotanist and the executive director of the [American Council on Wild and Volunteer Foods](/wiki/organizations/american-council-on-wild-and-volunteer-foods/), a position she has held since 2016. Her work concerns the boundary between food and not-food — specifically, the conditions under which a wild or unplanted organism can be said to constitute a genuine food source rather than merely an edible object that happens to exist.
...
**Voice and sensibility:** Dr. Stenholm is a deflationary expert of the gentlest kind. She never dismisses a claim outright; she quantifies it until the enthusiasm leaks out on its own. Asked whether a reflecting pool could feed the hungry, she will not say no — she will estimate, with care, exactly how many people it could feed and for how long, and the answer will be small. She treats foraging fantasies with complete respect and total rigor, which is precisely what defuses them.

**Verbal tics:** Distinguishes obsessively between "edible," "forageable," and "present." Uses the phrase "load-bearing" to describe whether a food source can actually sustain a person ("non-trivial but not load-bearing"). Notes when organisms are "enrolled in no program" or "simply present." Quantifies in oddly specific small units — "one adult, briefly."

**Obsessions:** The gap between perceived and actual caloric yield. The legal and bureaucratic status of wild organisms — whether a duck has been certified, whether a fountain has been authorized as a food source. The dignity of being precise about disappointing numbers.
