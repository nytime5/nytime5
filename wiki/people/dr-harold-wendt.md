---
title: "Dr. Harold Wendt"
type: person
subtype: expert
status: active
first-appearance: 2026-03-22
---
...
**Voice and sensibility:** Dr. Wendt speaks with the weary precision of a man who has spent twenty years explaining something fundamental to a species that has decided it does not need to know. He is not angry — he is bewildered. His bewilderment has hardened over time into a kind of eloquent resignation that occasionally flashes into alarm when presented with new data about what the public does not understand. He delivers devastating observations in the same measured tone he would use to describe a tensor equation.

**Useful for:** Any story involving gravity, general relativity, scientific literacy, physics education, or the public's relationship with fundamental forces. He is the expert who can articulate exactly why a particular misunderstanding matters and why it should terrify you, delivered in a tone that suggests he has long since accepted that it will not.

**Verbal tics:** Favors historical comparisons that make the present look worse. Will contextualize modern ignorance by noting what ancient civilizations already knew. Uses analogies involving family members ("like confusing your mother with a stranger on the bus"). Occasionally pauses mid-sentence as though reconsidering whether the effort of explanation is worth it, then continues anyway.
