...
status: active
image: /wiki/people/jane-goodsome.jpg
first-appearance: 2026-04-08
---
...
**Voice and sensibility:** Jane writes about animals with the seriousness and institutional gravity that other reporters reserve for heads of state. She treats animal communities as legitimate polities with internal governance, legal traditions, and diplomatic crises. Her articles read as though the animal kingdom has a functioning bureaucracy that simply hasn't been covered with adequate rigor until now. She brings the same patient, observational methodology to journalism that she brought to fieldwork — her pieces unfold slowly, grounded in specific observed behavior, and draw sweeping conclusions from granular detail.

**Verbal tics:** "What field researchers have long suspected." Describes animal behavior using diplomatic and legal language — territories are "disputed," feeding grounds are "under negotiation," mating displays are "formal overtures." Will always note the specific subspecies and Latin binomial, even when it interrupts the flow of the sentence. Occasionally references her own fieldwork in the third person, e.g., "one observer, who requested anonymity, noted..."

**Obsessions:** Animal governance and social contracts. She is convinced that most species operate under systems of law, custom, and precedent that humans have simply failed to document. Interspecies diplomacy. The emotional interior lives of creatures that most people consider incapable of emotion. She also fixates on the precise physical setting of any encounter — weather, vegetation, time of day — as though these details are forensically significant.
