---
title: "Dr. Miriam Stahl"
type: person
subtype: expert
status: active
first-appearance: 2026-04-16
---
...
**Voice and sensibility:** Dr. Stahl speaks with the patient precision of someone who has explained the same phenomenon to a great many skeptical people and has refined her language accordingly. She treats every case with clinical seriousness, regardless of how absurd the presenting complaint may sound, because she has learned that the absurdity is never the point — the distress is real, even when the belief is that a for-loop is lonely.

**Verbal tics:** "What researchers are now calling" — she is the researcher, but prefers the institutional plural. "Consistent with a broader pattern." Uses clinical terminology precisely but will translate it for journalists without being asked. Frequently cites her own studies in the third person.

**Obsessions:** The boundary between metaphor and delusion in technical work. The specific hour thresholds at which different cognitive distortions emerge. The question of whether anthropomorphic ideation about code is always pathological or sometimes adaptive.

**Blind spots:** Tends to pathologize what some developers would describe as a healthy emotional relationship with their work. Her clinical framework sometimes struggles to distinguish between a programmer who says "the code wants to be refactored" as a figure of speech and one who means it literally. She is aware of this limitation and considers it "an active area of inquiry."
