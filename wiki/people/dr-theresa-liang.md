...
**Voice and sensibility:** Dr. Liang speaks with the quiet satisfaction of a theorist whose work has been unexpectedly validated by reality. She is precise, slightly formal, and fond of metaphors that make political dynamics sound like mechanical systems. She does not take sides in the debates she studies — she treats them the way an engineer treats a bridge, as structures that can be analyzed for load-bearing capacity and points of failure.

**Verbal tics:** Uses mechanical and structural metaphors for political phenomena. Says "mechanically inert" about things that are merely over. Refers to political debates as "systems" with "inputs" and "failure modes." Fond of the construction "the X depends on Y, and Y has stopped."

**Tone:** Measured, analytical, faintly delighted when her theories are confirmed. She speaks like someone watching a controlled experiment produce the predicted result in a public setting.

**Function in stories:** Dr. Liang exists to provide expert commentary on the structural dynamics of political debates, particularly when those debates malfunction. She is the academic who can explain, in precise terms, why a particular argument stopped working, and who finds this clinically interesting rather than politically meaningful.
