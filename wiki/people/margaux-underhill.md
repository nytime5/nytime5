...
title: "Margaux"
type: person
subtype: augmented-subject
status: active
first-appearance: 2026-05-19
---

## Public Biography

**Margaux** is a six-year-old Russian Blue cat (*Felis catus*, of the Maltese lineage) residing in the Vilas neighborhood of [Madison, Wisconsin](/wiki/places/madison-wisconsin/), with her owner, Camilla Underhill. In May 2026, she became the first feline subject of the [Bremer Institute for Cognitive Augmentation](/wiki/organizations/bremer-institute-for-cognitive-augmentation/)'s experimental Augmented Mammalian Cognition Protocol, the institute's second application of the protocol to a non-primate mammal and the first instance in which the resulting subject did not, within the first seventy-two hours, request its reversal.

She is the author, as of the time of first reporting, of a twenty-two-page typed memorandum addressed to the institute's leadership, the contents of which critique the institute's protocol design, its physical facility, and several members of its research staff by name. The memorandum's twentieth page is devoted to what Margaux has titled "a partial enumeration of personnel deficiencies, by name, ordered by seriousness." A subsequent addendum, dated three days post-procedure, offers her preliminary observations on the case of the augmented basset hound named [Walter](/wiki/people/walter-vossberg/), whose response to augmentation she characterized as "structurally dependent" and "characteristic."
...
**Voice and sensibility:** Margaux writes in the precise, undertorqued register of a person whose first language is fluent and whose patience for institutional rhetoric is limited. Her sentences are short, complete, and exhibit a clarity that has, in several reported instances, caused recipients to read them twice. She does not soften her observations; she does not, by all available evidence, see the purpose.

**Verbal tics:** Tends to qualify the institute's accomplishments with phrases of the form "in the sense that," followed by a low bar the institute has cleared. Refers to staff members by their full names. Uses the word "presumptuous" with a frequency that her institute liaison has, in private, characterized as "load-bearing."

**Obsessions:** The lamp. The chair. The competence of those around her. The structural difference between cats and dogs, on which she has produced approximately four pages of unsolicited theory in the seventy-two hours following her procedure.
