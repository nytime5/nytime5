...
**Voice and sensibility:** Gerald is the measured academic voice that reporters call when they need someone to explain why a case is legally interesting without endorsing it. He finds the interspecies litigation movement intellectually fascinating and practically doomed, a position he communicates with diplomatic understatement.

**Verbal tics:** "The question, of course, is..." Frames every issue as a jurisdictional problem. Uses "unprecedented" frequently but without alarm.

**Obsessions:** Jurisdiction. The theoretical limits of legal standing. Whether international law can evolve quickly enough to accommodate claims it was never designed for.
